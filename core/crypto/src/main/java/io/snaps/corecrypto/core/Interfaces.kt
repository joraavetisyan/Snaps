...
import io.snaps.corecrypto.entities.AddressData
...
import io.snaps.corecrypto.entities.LaunchPage
import io.snaps.corecrypto.entities.RestoreSettingRecord
import io.snaps.corecrypto.entities.SyncMode
...
import io.snaps.corecrypto.other.AmountInputType
import io.snaps.corecrypto.other.BalanceSortType
import io.snaps.corecrypto.other.FilterTransactionType
import io.snaps.corecrypto.other.Value
...
sealed class FeeRatePriority(val titleRes: Int) {
    object LOW : FeeRatePriority(0)
    object RECOMMENDED : FeeRatePriority(0)
    object HIGH : FeeRatePriority(0)

    class Custom(val value: Long) : FeeRatePriority(0)
}
