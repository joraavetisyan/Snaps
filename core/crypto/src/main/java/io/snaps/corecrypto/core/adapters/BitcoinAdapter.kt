...
class BitcoinAdapter(
    ...
    wallet: Wallet,
    testMode: Boolean
) : BitcoinBaseAdapter(kit, syncMode, backgroundManager, wallet, testMode), BitcoinKit.Listener,
    ISendBitcoinAdapter {
    ...
    companion object {
        ...
        private fun createKit(
            ...
            when (accountType) {
                ...
                is AccountType.Mnemonic -> {
                    val derivation = wallet.coinSettings.derivation
                        ?: throw AdapterErrorWrongParameters("Derivation not set")
        ...
        fun clear(walletId: String, testMode: Boolean) {
            BitcoinKit.clear(CryptoKit.instance, getNetworkType(testMode), walletId)
        }
    }
}
