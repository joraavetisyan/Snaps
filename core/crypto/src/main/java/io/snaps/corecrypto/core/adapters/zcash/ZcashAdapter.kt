package io.snaps.corecrypto.core.adapters.zcash
...
class ZcashAdapter(
    ...
    override fun send(amount: BigDecimal, address: String, memo: String): Single<Unit> =
            Single.create { emitter ->
                try {
                    ...
                    log("call synchronizer.sendToAddress")
    ...
    companion object {
        ...
        fun clear(accountId: String, testMode: Boolean) {
            ...
            runBlocking {
                Initializer.erase(io.snaps.corecrypto.core.CryptoKit.instance, network, getValidAliasFromAccountId(accountId))
            }
        }
    }
}
