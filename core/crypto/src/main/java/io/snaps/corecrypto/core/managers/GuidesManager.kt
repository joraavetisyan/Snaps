...
import io.snaps.corecrypto.entities.Guide
import io.snaps.corecrypto.entities.GuideCategoryMultiLang
...
object GuidesManager {
    ...
    private val guidesUrl = CryptoKit.appConfigProvider.guidesUrl
