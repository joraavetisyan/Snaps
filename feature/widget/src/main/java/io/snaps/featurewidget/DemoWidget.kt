package io.snaps.featurewidget
...
import io.snaps.featurewidget.glance.GlanceTheme
import io.snaps.featurewidget.glance.appWidgetBackgroundModifier
import io.snaps.featurewidget.glance.cornerRadius
import io.snaps.featurewidget.glance.stringResource
...
class DemoWidget : GlanceAppWidget() {
    ...
    private fun ColumnScope.OpenApp() {
        val intent = Intent(Intent.ACTION_VIEW, "app://io.snaps.appdemo/demo".toUri())
