package com.defince.featurewidget
...
import com.defince.featurewidget.glance.GlanceTheme
import com.defince.featurewidget.glance.appWidgetBackgroundModifier
import com.defince.featurewidget.glance.cornerRadius
import com.defince.featurewidget.glance.stringResource
...
class DemoWidget : GlanceAppWidget() {
    ...
    private fun ColumnScope.OpenApp() {
        val intent = Intent(Intent.ACTION_VIEW, "app://com.defince.appdemo/demo".toUri())
